/**
 * Terminal-direction primitives shared across screens. Lifted verbatim from
 * FounderOS's design system. Server-component friendly: no state, no handlers.
 */

export type DotState = 'ok' | 'warn' | 'err' | 'off';

const DOT_FOR: Record<string, DotState> = {
  // engine statuses (sessions/phases) map onto the traffic-light rule
  success: 'ok',
  running: 'warn',
  queued: 'off',
  fail: 'err',
